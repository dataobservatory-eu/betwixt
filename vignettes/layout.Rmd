...
In the dual-wide representation, `input_relation` is itself a candidate assertion. It remains distinct from review provenance, which records who performed the review, when the review took place, and what decisions were made.
...
dual_review_file <- render_review(
  delini_dual,
  cols = c(
    input_relation = "Evidence relation",
    subject = "Subject",
    instance_of = "instance of",
    heritage_of = "heritage of",
    context_1 = "held by"
