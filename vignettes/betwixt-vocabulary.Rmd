...
Each row in the long projection represents one assertion. `row_id` retains its relationship to the original review matrix, while `assertion_number` identifies the assertion within the projection.
