...
# Betwixt: Scoped Semantic Claims and Human Review
...
A _candidate claim_ is derived from one or more observations and inherits their provenance. The claim is then subjected to human _review_, creating a second layer of provenance that records who _reviewed the claim_, under what conditions, and with what _outcome_. The result is not merely an accepted or rejected assertion, but a reviewed claim whose semantic content and stabilisation history are both explicitly represented.
...
## 3. Review as Semantic Stabilisation
...
candidate_claim_df ↓ render() ↓ HTML / CSS ↓ reviewer ↓ reviewed_claim_df
