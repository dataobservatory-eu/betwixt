...
The candidate dataset defines the **input to review**. Reviewer decisions and comments are not added to `candidate_dataset()` because they belong to the resulting review state rather than to the candidate state.
