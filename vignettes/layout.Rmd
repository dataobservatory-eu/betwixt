...
Evidence is deliberately kept distinct from the candidate assertions being reviewed. The Dēliņi example can provide an evidence resource through `input_url`, directly displayable media through `input_media_url`, and a short identification through `input_description`.
...
In the dual-wide representation, `input_predicate` is itself a candidate assertion. It remains distinct from review provenance, which records who performed the review, when the review took place, and what decisions were made.
...
dual_review_file <- render_review(
  delini_dual,
  cols = c(
    input_predicate = "Evidence relation",
    subject = "Subject",
    instance_of = "instance of",
    heritage_of = "heritage of",
    context_1 = "held by"
